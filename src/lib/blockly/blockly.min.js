...
Blockly.constants.COLLAPSED_FIELD_NAME="_TEMP_COLLAPSED_FIELD";Blockly.utils={};Blockly.utils.global=function(){return"object"===typeof self?self:"object"===typeof window?window:"object"===typeof global?global:this}();Blockly.Msg={};Blockly.utils.global.Blockly||(Blockly.utils.global.Blockly={});Blockly.utils.global.Blockly.Msg||(Blockly.utils.global.Blockly.Msg=Blockly.Msg);Blockly.utils.colour={};
...
Blockly.Css.inject=function(a,b,c){if(!Blockly.Css.injected_){Blockly.Css.injected_=!0;var d=Blockly.Css.CONTENT.join("\n");Blockly.Css.CONTENT.length=0;a&&(a=b.replace(/[\\/]$/,""),d=d.replace(/<<<PATH>>>/g,a),a=document.createElement("style"),a.id="blockly-common-style",d=document.createTextNode(d),a.appendChild(d),c?(console.log("[Blockly Shadow CSS]",c),c.appendChild(a)):document.head.insertBefore(a,document.head.firstChild))}};
...
Blockly.utils.toolbox.Position.BOTTOM:p==m?Blockly.utils.toolbox.Position.RIGHT:Blockly.utils.toolbox.Position.LEFT;this.shadowRoot=a.shadowRoot;Blockly.shadowRoot=this.shadowRoot;var q=a.css;void 0===q&&(q=!0);var t="https://blockly-demo.appspot.com/static/media/";a.media?t=a.media:a.path&&(t=a.path+"media/");var r=void 0===a.oneBasedIndex?!0:!!a.oneBasedIndex,u=a.renderer||"geras",v=a.plugins||{};this.RTL=m;this.oneBasedIndex=r;this.collapse=f;this.comments=g;this.disable=h;this.readOnly=b;this.maxBlocks=
...
this.renderer=u;this.rendererOverrides=a.rendererOverrides;this.gridPattern=null;this.parentWorkspace=a.parentWorkspace;this.plugins=v};Blockly.BlocklyOptions=function(){};
...
Blockly.FlyoutMetricsManager.prototype.getScrollMetrics=function(a,b,c){b=c||this.getContentMetrics();c=this.flyout_.MARGIN*this.workspace_.scale;a=a?this.workspace_.scale:1;return{height:(b.height+2*c)/a,width:(b.width+b.left+c)/a,top:0,left:0}};Blockly.ComponentManager=function(){this.componentData_={};this.capabilityToComponentIds_={}};Blockly.ComponentManager.prototype.addComponent=function(a){this.componentData_[a.id]=a;for(var b=0,c;c=a.capabilities[b];b++)c=String(c).toLowerCase(),void 0===this.capabilityToComponentIds_[c]?this.capabilityToComponentIds_[c]=[a.id]:this.capabilityToComponentIds_[c].push(a.id)};Blockly.ComponentManager.prototype.getComponent=function(a){return this.componentData_[a]&&this.componentData_[a].component};
...
Blockly.WorkspaceSvg.prototype.clearGesture=function(){this.currentGesture_=null};Blockly.WorkspaceSvg.prototype.cancelCurrentGesture=function(){this.currentGesture_&&this.currentGesture_.cancel()};Blockly.WorkspaceSvg.prototype.getAudioManager=function(){return this.audioManager_};Blockly.WorkspaceSvg.prototype.getGrid=function(){return this.grid_};Blockly.inject=function(a,b){Blockly.checkBlockColourConstants();"string"==typeof a&&(a=document.getElementById(a)||document.querySelector(a));b=new Blockly.Options(b||{});if(!Blockly.utils.dom.containsNode(b.shadowRoot||document,a))throw"Error: container is neither in current document nor in shadow root.";var c=document.createElement("div");c.className="injectionDiv";c.tabIndex=0;Blockly.utils.aria.setState(c,Blockly.utils.aria.State.LABEL,Blockly.Msg.WORKSPACE_ARIA_LABEL);a.appendChild(c);a=Blockly.createDom_(c,
b);var d=new Blockly.BlockDragSurfaceSvg(c),e=new Blockly.WorkspaceDragSurfaceSvg(c),f=Blockly.createMainWorkspace_(a,b,d,e);Blockly.init_(f);Blockly.mainWorkspace=f;Blockly.svgResize(f);c.addEventListener("focusin",function(){Blockly.mainWorkspace=f});return f};
Blockly.createDom_=function(a,b){a.setAttribute("dir","LTR");Blockly.Css.inject(b.hasCss,b.pathToMedia,b.shadowRoot);a=Blockly.utils.dom.createSvgElement(Blockly.utils.Svg.SVG,{xmlns:Blockly.utils.dom.SVG_NS,"xmlns:html":Blockly.utils.dom.HTML_NS,"xmlns:xlink":Blockly.utils.dom.XLINK_NS,version:"1.1","class":"blocklySvg",tabindex:"0"},a);var c=Blockly.utils.dom.createSvgElement(Blockly.utils.Svg.DEFS,{},a),d=String(Math.random()).substring(2);b.gridPattern=Blockly.Grid.createDom(d,b.gridOptions,c);
return a};
...
d.setAttribute("type","variables_get_dynamic"),d.setAttribute("gap",8),d.appendChild(Blockly.Variables.generateVariableFieldDom(e)),b.push(d)}}return b};Blockly.ZoomControls=function(a){this.workspace_=a;this.zoomResetGroup_=this.zoomOutGroup_=this.zoomInGroup_=this.onZoomOutWrapper_=this.onZoomInWrapper_=this.onZoomResetWrapper_=null};Blockly.ZoomControls.prototype.WIDTH_=32;Blockly.ZoomControls.prototype.HEIGHT_=32;Blockly.ZoomControls.prototype.SMALL_SPACING_=2;Blockly.ZoomControls.prototype.LARGE_SPACING_=11;Blockly.ZoomControls.prototype.MARGIN_VERTICAL_=20;Blockly.ZoomControls.prototype.MARGIN_HORIZONTAL_=20;
...
Blockly.ZoomControls.prototype.init=function(){this.workspace_.getComponentManager().addComponent({id:"zoomControls",component:this,weight:2,capabilities:[Blockly.ComponentManager.Capability.POSITIONABLE]});this.initialized_=!0};
...
a),this.debugFilterId=a.id,this.debugFilter_=a)};var shadowR=void 0;
Blockly.blockRendering.ConstantProvider.prototype.injectCSS_=function(a,b){void 0===Blockly.shadowRoot&&(Blockly.shadowRoot=shadowR);b=this.getCSS_(b);a="blockly-renderer-style-"+a;Blockly.shadowRoot?(shadowR=Blockly.shadowRoot,this.cssNode_=Blockly.shadowRoot.getElementById(a)):this.cssNode_=document.getElementById(a);var c=b.join("\n");this.cssNode_?this.cssNode_.firstChild.textContent=c:(b=document.createElement("style"),b.id=a,a=document.createTextNode(c),b.appendChild(a),Blockly.shadowRoot?(console.log("[Blockly Shadow CSS II]"),
Blockly.shadowRoot.appendChild(b)):document.head.insertBefore(b,document.head.firstChild),this.cssNode_=b)};
