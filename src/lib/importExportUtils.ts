...
const exportedSettingsSchema = z.object({
    ...
    enableCompletionInViewMode: booleanCoerce.optional().default(true),
    enableAICompletion: booleanCoerce.optional().default(false),
...
export async function exportToZip(
    ...
    const settings: IExportedSettings = {
        ...
        enableCompletionInViewMode: mainBlock.enableCompletionInViewMode,
        enableAICompletion: mainBlock.enableAICompletion,
