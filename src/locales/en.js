export default {
    ...
    AICompletion: {
        Title: 'Enable AI Code Completion?',
        Description: 'Use AI-powered code suggestions to help you write code faster.',
        Benefits: 'Benefits:',
        BenefitSmart: 'Smart suggestions based on your code context',
        BenefitFast: 'Fast completion runs entirely in your browser',
        BenefitPrivate: 'Privacy-first: Your code never leaves your device',
        Note: 'Important:',
        NoteText:
            'The AI model needs to be downloaded once (~1 GB). It will then be cached in your browser and also works offline. Depending on your connection this may take several minutes and may incur data charges (e.g. on mobile plans).',
        NotNow: 'Not Now',
        Accept: 'Download & Enable',
    },
    CodeBlocksSettings: {
        EmitAST: 'Emit AST',
        Runtime: 'Runtime',
