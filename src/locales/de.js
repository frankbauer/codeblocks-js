export default {
    ...
    AICompletion: {
        Title: 'KI-Code-Vervollständigung aktivieren?',
        Description: 'Verwenden Sie KI-gestützte Code-Vorschläge, um schneller Code zu schreiben.',
        Benefits: 'Vorteile:',
        BenefitSmart: 'Intelligente Vorschläge basierend auf Ihrem Code-Kontext',
        BenefitFast: 'Schnelle Vervollständigung läuft vollständig in Ihrem Browser',
        BenefitPrivate: 'Datenschutz: Ihr Code verlässt niemals Ihr Gerät',
        Note: 'Wichtiger Hinweis:',
        NoteText:
            'Das KI-Modell muss einmalig heruntergeladen werden (~1 GB). Es wird anschließend in Ihrem Browser zwischengespeichert. Je nach Verbindung kann der Download mehrere Minuten dauern und Kosten verursachen (z. B. bei mobilen Datentarifen). Das Modell ist nach dem ersten Download auch offline verfügbar.',
        NotNow: 'Jetzt nicht',
        Accept: 'Herunterladen & aktivieren',
    },
    CodeBlocksSettings: {
        ...
        Language: 'Sprache',
        EnableAICompletion: 'KI-Vervollständigung aktivieren',
