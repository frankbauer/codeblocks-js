        ...
        <div v-if="editMode">
            ...
            >
                <div class="tw-flex tw-items-center tw-flex-1">
                    <div
                        class="tw-ml-0 tw-transition-opacity tw-duration-250 group-hover:tw-opacity-0"
                    >
...
// Stable host for this library's custom UI, always mounted (edit and view mode alike).
...
onMounted(() => {
    if (libraryElementHostRef.value) {
        block.value.libraryElementHost = $(libraryElementHostRef.value)
    }
    whenBlockIsReady()
